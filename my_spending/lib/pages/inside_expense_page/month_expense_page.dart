...
class MonthExpensePage extends StatefulWidget {
  @override
  _MonthExpensePageState createState() => _MonthExpensePageState();
}
      ...
      children: <Widget>[
        Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              StreamBuilder<List<Expense>>(builder: (context, snapshot){
                return Container(
                    width: (widthDevice - 20.0) / 4,
                    child: RaisedButton(
                        ...
                        onPressed: (){
                          expenseBloc.getMonthExpense(_currentMon, _currentYear, idUser);
                          expenseBloc.getMonthTotalExpense(_currentMon, _currentYear, idUser);
                        })
                );
              },)
        ...
        Container(
          ...
          child: StreamBuilder<List<Expense>>(
            stream: expenseBloc.outExpenseListMonth,
        ...
        Container(
            height: 40.0,
            child: StreamBuilder(
                stream: expenseBloc.outExpenseMonth,
                builder: (context, snapshot){
                  if(snapshot.hasData){
                    return Container(
                      color: Colors.white,
